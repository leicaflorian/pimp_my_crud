  ...
  <div class="bg-light border-bottom mb-4">
    <div class="container">
      <div class="nav justify-content-center">
        <a class="nav-link" href="{{ route('{{ resource }}.create') }}">Add {{ resourceSingular }}</a>
      </div>
    </div>
  </div>
                ...
                <td>
                  <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                    ...
                    <a type="button" class="btn btn-primary" title="Edit"
                       href="{{ route('{{ resource }}.edit', ${{ resourceSingular }}->id) }}">
                    ...
                    <a type="button" class="btn btn-warning" title="Show"
                       href="{{ route('{{ resource }}.show', ${{ resourceSingular }}->id) }}">
